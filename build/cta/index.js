...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "mx-auto max-w-2xl md:text-center text-left"
    ...
    allowedBlocks: ['create-block/cta-button', 'create-block/cta-button-icon', 'create-block/cta-link'],
    template: [['create-block/cta-button'], ['create-block/cta-link']]
  })));
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/cta-block","version":"0.1.0","title":"CTA Block","category":"widgets","icon":"megaphone","description":"Add a call action to help the user make a decision about contacting you.","example":{},"supports":{"html":false},"textdomain":"blox-site","editorScript":"file:./index.js","editorStyle":["file:../block.css","file:./index.css"],"style":["file:./style-index.css","file:../block.css"],"viewScript":"file:./view.js"}');
